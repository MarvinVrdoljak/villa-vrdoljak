...
$style = "style='";
	...
	$style .= "font-size:" . $radial_size * 1.25 . "%;"; // TODO: impostare un min e un max value
		...
		<?php if ( ! empty( $icon ) && $radial_data != '' ) : ?>
			<?php if ( empty( $hide_radial_data ) ) : ?>
				<p class="thb-radial-chart-data-value thb-outside">
					<span class="thb-radial-chart-step-value thb-outside"><?php echo $radial_data; ?></span><span class="thb-radial-chart-unit"><?php echo $radial_unit; ?></span>
				</p>
			<?php endif; ?>
		<?php endif; ?>
